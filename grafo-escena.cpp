...
void NodoGrafoEscena::visualizarGL( ContextoVis& cv )
{
  ...
  //   case objeto:
  //     //TODO Aplicar transformacion al objeto.
 
  //     transf_acumuladas = MAT_Ident();

  //     entrada.visualizarGL();

  //     break;

  //   case transformacion:

  //     transf_acumuladas = transf_acumuladas * entrada.matriz;
